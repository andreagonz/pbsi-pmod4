...
def addOptions():
    ...
    parser.add_option('-n', '--num-res', dest='num_res', default='50', help='Numero de resutados')
    ...
    parser.add_option('-r', '--regex', dest='regex', default=False, action="store_true", help='Se pueden usar Expreisones Regullares')
    ...
    parser.add_option('-U', '--user-agents', dest='user_agents', default=None, help='Hace uso de diferentes agentes de usuario')
    parser.add_option('-P', '--proxies', dest='proxies', default=None, help='Al ser utilizada, se anonimiza la busqueda')
    ...
    parser.add_option('-p', '--ip', dest='ip', default=None, help='Se especifica la IP de busqueda')
    parser.add_option('-m', '--mail', dest='mail', default=None, help='Busca mails')
    parser.add_option('-f', '--filetype', dest='filetype', default=None, help='Se busca por tipode archivo')
    parser.add_option('-s', '--site', dest='site', default=None, help='Se busca opr sitio web')
    parser.add_option('-e', '--exclude', dest='exclude', default=None, help='Se usa como - ya que no busa esa palabra')
    parser.add_option('-I', '--include', dest='include', default=None, help='Se incluyen los resultados que contengan esa palabra')
    parser.add_option('-u', '--inurl', dest='inurl', default=None, help='Se busca la palabra dentro de la url')
